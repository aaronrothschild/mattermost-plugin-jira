...
![You can create a Jira issue from any Mattermost message](../.gitbook/assets/image-5.png)
...
![You can attach a message to an existing Jira ticket](../.gitbook/assets/image-6.png)
